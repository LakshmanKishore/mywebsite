...
export const SocialLinks = ({ ulClassNames, liClassNames }) => {
    return (
        <ul className={ulClassNames}>
            ...
            <SocialLinkItem liClassNames={liClassNames} name="Twitter/X" href="https://twitter.com/Lakshman007bff" icon="pajamas:twitter" />
            <SocialLinkItem liClassNames={liClassNames} name="Hashnode" href="https://lakshman007bff.hashnode.dev" icon="simple-icons:hashnode" />
        </ul>
    )
}
